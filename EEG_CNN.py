...
def CNN(reg=0, pool_size=3, use_max_pool=True, dropout=0.5, filters=[10 for _ in range(4)], affine_layer_sizes=[], num_filters=[25, 50, 100, 200], input_shape=(500, 1, 22), output_classes=4):
    model = Sequential()
